...
public final class GreeterGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "test.Greeter";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<test.Helloworld.HelloRequest,
      test.Helloworld.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = test.Helloworld.HelloRequest.class,
      responseType = test.Helloworld.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<test.Helloworld.HelloRequest,
      test.Helloworld.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<test.Helloworld.HelloRequest, test.Helloworld.HelloReply> getSayHelloMethod;
    if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
      synchronized (GreeterGrpc.class) {
        if ((getSayHelloMethod = GreeterGrpc.getSayHelloMethod) == null) {
          GreeterGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<test.Helloworld.HelloRequest, test.Helloworld.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  test.Helloworld.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  test.Helloworld.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(test.Helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<test.Helloworld.HelloReply> responseObserver) {
  ...
  public static final class GreeterStub
     ...
     * </pre>
     */
    public void sayHello(test.Helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<test.Helloworld.HelloReply> responseObserver) {
  ...
  public static final class GreeterBlockingStub
     ...
     * </pre>
     */
    public test.Helloworld.HelloReply sayHello(test.Helloworld.HelloRequest request) {
  ...
  public static final class GreeterFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<test.Helloworld.HelloReply> sayHello(
        test.Helloworld.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((test.Helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<test.Helloworld.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              test.Helloworld.HelloRequest,
              test.Helloworld.HelloReply>(
