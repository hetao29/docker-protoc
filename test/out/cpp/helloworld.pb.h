...
inline std::string* HelloRequest::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:test.HelloRequest.name)
...
inline void HelloRequest::unsafe_arena_set_allocated_name(
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:test.HelloRequest.name)
}
...
inline std::string* HelloReply::unsafe_arena_release_message() {
  // @@protoc_insertion_point(field_unsafe_arena_release:test.HelloReply.message)
  GOOGLE_DCHECK(GetArena() != nullptr);
...
inline void HelloReply::unsafe_arena_set_allocated_message(
  ...
  message_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      message, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:test.HelloReply.message)
}
